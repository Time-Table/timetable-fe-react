...
export default function StartPage() {
  ...
  return (
    <>
      ...
      <PageWrapper>
        <Hero>
          <Badge {...rise(reduceMotion, 0)}>회원가입 없이 · 링크 공유 · 무료</Badge>
          ...
          <Lead {...rise(reduceMotion, 2)}>
            각자 가능한 시간을 저장하면, 함께 만날 수 있는 시간대를 비교할 수 있습니다.
          </Lead>
        ...
        <Explainer>
          ...
          {/* 구글 검색 결과 설명에 메타 설명 대신 이 목록이 뽑혔다. 스니펫에서 뺀다.
              data-nosnippet은 div·span·section에서만 동작하므로 ul이 아니라 감싼 div에 단다. */}
          <div data-nosnippet>
            <h2>이 페이지에서 하는 일</h2>
            <ul>
              <li>모임 이름과 후보 날짜, 시간 범위를 정합니다</li>
              <li>'이대로 만들기'를 누르고 시간 잠금을 확인한 뒤 생성을 완료하면 공유용 링크가 만들어집니다</li>
              <li>참여자는 이름(닉네임)과 비밀번호를 입력하고 가능한 시간을 선택한 뒤 저장합니다</li>
              <li>저장된 응답을 기준으로 가능한 인원이 많은 시간대가 골든타임으로 추천됩니다</li>
            </ul>
          </div>
          <p>
