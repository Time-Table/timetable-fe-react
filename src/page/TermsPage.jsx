...
export default function TermsPage() {
  // h1 → h2 단계를 지키되, 브라우저 기본 h3 크기와 여백을 그대로 둬 화면은 바뀌지 않는다.
  const sectionHeading = { fontSize: "1.17em", margin: "1em 0" };
  return (
    <>
    ...
    >
      <h1 style={{ color: theme.color.primary, fontSize: "24px", fontWeight: "bold" }}>
        📜 타임테이블 이용약관
      </h1>
      ...
      >
        ...
        <h2 style={sectionHeading}>제3조 (약관의 효력 및 변경)</h2>
        ...
        <h2 style={sectionHeading}>제6조 (개인정보 보호)</h2>
        <p>
          서비스는 이용자의 개인정보를 보호하기 위해 노력하며, 개인정보 보호 관련 사항은
          개인정보처리방침을 따릅니다.
        </p>

        <h2 style={sectionHeading}>제7조 (서비스 제공 및 변경)</h2>
        <p>
        ...
        <h2 style={sectionHeading}>제8조 (면책 조항)</h2>
        <p>
          서비스는 천재지변, 서버 장애, 해킹 등 불가항력적인 사유로 인해 발생한 문제에 대해서는
          책임을 지지 않습니다.
        </p>

        <h2 style={sectionHeading}>제9조 (이용 계약 해지 및 탈퇴)</h2>
        <p>
          이용자는 언제든지 서비스에서 탈퇴할 수 있으며, 탈퇴 시 계정과 관련된 모든 데이터가
          삭제됩니다.
        </p>

        <h2 style={sectionHeading}>제10조 (분쟁 해결 및 준거법)</h2>
